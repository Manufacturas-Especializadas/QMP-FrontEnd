        ...
        {CHECKPOINTS.map((cp) => {
          ...
          return (
            ...
            >
              ...
              <div
                className="flex gap-1.5 bg-slate-100 p-1 rounded-xl shrink-0 self-start 
                sm:self-center"
              >
                <button
                  type="button"
                  onClick={() => handleSelectOption(cp.key, 1)}
                ...
                <button
                  type="button"
                  onClick={() => handleSelectOption(cp.key, 2)}
                  className={`px-3 py-1.5 rounded-lg text-[10px] uppercase font-black tracking-wider transition-all cursor-pointer ${
                    currentValue === 2
                ...
                <button
                  type="button"
                  onClick={() => handleSelectOption(cp.key, 3)}
                  className={`px-3 py-1.5 rounded-lg text-[10px] uppercase font-black tracking-wider transition-all cursor-pointer ${
                    currentValue === 3
