            ...
            <div className="flex gap-1 bg-slate-50 p-0.5 rounded-lg border border-slate-100">
              {[
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded text-[8px] uppercase font-black transition-all cursor-pointer ${currentFinding[v.key] === o.v ? "bg-slate-800 text-white shadow-sm" : "text-slate-400 hover:text-slate-600"}`}
                >
                  {o.l}
                </button>
              ))}
